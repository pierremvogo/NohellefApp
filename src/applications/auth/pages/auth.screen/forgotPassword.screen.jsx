                        ...
                        <GridContainer>
                          <GridItem xs={12} sm={12} md={12}>
                            ...
                            <div style={{
                                fontSize:'1.5vw',
                                margin:'0%',
                                }}>Avez-vous perdu ou oublié votre mot de passe?<br/>
									<p style={{marginLeft:'10%'}}><strong>sans problème nous gérons le problème</strong></p>
                            </div>
                                ...
                                <GridContainer>
                                  ...
                                  <GridContainer>
                                    <GridItem xs={12} sm={12} md={12}>
                                      ...
                                      <input type='email' placeholder="Entrer votre adresse Email" style={{
                                        borderRadius:'10px',

  ...
  const closeModal = (e) => {
    ...
    Object.keys(values).map((input,index)=>{
        switch(input) {
            ...
            case 'oldPassword':
                if(!values[input]){
                    errorsValidation.oldPassword = "Le Nouveau mot de passe est requis";
                }else if(!regexPassword.test(values[input])){
            ...
            case 'newPassword':
                if(!values[input]){
                    errorsValidation.newPassword = "Veuillez confirmer le mot de passe";
                }else if(values['oldPassword'] != values[input]){
                    errorsValidation.newPassword = "Confirmation de mot de passe invalide";
                }else{
                     setSubmited(true)
                }
                break;

...
import p1 from '../../../../assets/images/dashboard/p1.png';
import p2 from '../../../../assets/images/dashboard/p2.png';
                    ...
                    <ProSidebar style={{width:'100%'}}>
                      ...
                      <GridContainer>
                            <GridItem xs={12} sm={12} md={12}>
                                ...
                                <span className="text">Observation des tuteurs</span>
                              </div>
                            </GridItem>
                      ...
                      <GridContainer>
                            <GridItem xs={12} sm={12} md={12}>
                               <div className="side-content" id="myDiv3" onClick={()=>changeStyle('myDiv3')}>
                                ...
                                <span className="text">Progression de votre enfant</span>
                              </div>
                            </GridItem>

                        ...
                        <GridContainer>
                          <GridItem xs={12} sm={12} md={12}>
                              <div style={{
                                ...
                                <GridContainer>
                                    <GridItem xs={12} sm={12} md={12}>
                                     ...
                                     <div style={{margin:'2% 0% 1% 0%',cursor:'pointer'}}>
                                         <span style={{float:'left',marginRight:'5%'}}>Nom du tuteur</span>
                                         <span></span>
                                     </div>
                                    </GridItem>
                                  </GridContainer>
                                  ...
                                  <GridContainer>
                                    <GridItem xs={12} sm={12} md={12}>
                                       <select name="pets" id="pet-select">
                                                ...
                                                <option value="dog">Ngono Marie</option>
                                                <option value="cat">Rouson denis</option>
                                                <option value="hamster">Alain pirate</option>
                                                <option value="parrot">Loster jean</option>
                                                <option value="spider">Paul pirate</option>
                                                <option value="goldfish">Saul andre</option>
                                              </select>
                                    </GridItem>
                                  </GridContainer>
                                  ...
                                  <GridContainer>
                                    <GridItem xs={12} sm={12} md={12}>
                                     ...
                                     <div style={{margin:'2% 0% 1% 0%',cursor:'pointer'}}>
                                         <span style={{float:'left',marginRight:'5%'}}>Discipline</span>
                                         <span></span>
                                     </div>
                                    </GridItem>
                                  </GridContainer>
                                  ...
                                  <GridContainer>
                                    <GridItem xs={12} sm={12} md={12}>
                                     ...
                                     <div style={{margin:'2% 0% 1% 0%',cursor:'pointer'}}>
                                         <span style={{float:'left'}}>Nom du cours</span>
                                ...
                                <span className="text" style={{fontSize:'100%',color:'white'}}>Soumettre</span>
                              </div>
                                    </div>

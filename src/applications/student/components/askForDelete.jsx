...
const DeletePayment = ({error,
  ...
  const onChangeResetForm = (e) => {
    ...
    const onSubmit = (e) => {
        handleLoading(true);
          userService.deleteUserPaymentCard(idPayment)
            .then((response) => {
                    dispatch(authConfirmEmailFailed(null));
                        ...
                        <GridContainer>
                          <GridItem xs={12} sm={12} md={12}>
                            <div style={{
                                ...
                                margin:'5%',
                                textAlign:'center',
                                }}>Voulez vous vraiment Supprimer cette Carte de Paiement?
                                </div>
                          </GridItem>
                        </GridContainer>
...
export default connect(mapStateToProps)(DeletePayment);

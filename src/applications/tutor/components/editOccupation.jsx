...
const EditOccupation = ({error,occupationData}) => {
    ...
    useEffect(()=>{
        console.log("my payment data", occupationData);
                                ...
                                <GridContainer>
                                    <GridItem xs={12} sm={12} md={6}>
                                      <GridContainer>
                                      	<GridItem  xs={12} sm={12} md={12}>
                                           ...
                                           <span style={{float:'left',marginRight:'5%'}}>Du</span>
                                     ...
                                     <GridContainer>
                                      	<GridItem  xs={12} sm={12} md={12}>
                                      	 <div style={{margin:'2% 0% 1% 0%',cursor:'pointer'}}>
                                           <span style={{float:'left',marginRight:'5%'}}>Au</span>
                                  ...
                                  <GridContainer>
                                    <GridItem xs={12} sm={12} md={12}>
                                     ...
                                     <div style={{margin:'2% 0% 1% 0%',cursor:'pointer'}}>
                                         <span style={{float:'left',marginRight:'5%'}}>Heure</span>
                                         <span></span>
                                     </div>
                                    </GridItem>
                                  </GridContainer>
                                    ...
                                    <GridContainer>
                                            ...
                                            <GridItem xs={12} sm={12} md={12}>
			                                  <select name="pets" id="pet-select">
			                                    ...
			                                    <option value="dog">{occupationData.heure}</option>
			                                    ...
			                                    <option value="goldfish">14h00-14h00</option>
                                  ...
                                  <GridContainer>
                                    <GridItem xs={12} sm={12} md={12}>
                                     ...
                                     <div style={{margin:'2% 0% 1% 0%',cursor:'pointer'}}>
                                         <span style={{float:'left'}}>Jour</span>
                                    ...
                                    <GridItem xs={12} sm={12} md={12}>
                                       ...
                                       <select name="pets" id="pet-select">
			                                    ...
			                                    <option value="dog">Mardi</option>
			                                    <option value="cat">Mercredi</option>
			                                    <option value="hamster">Jeudi</option>
			                                    <option value="parrot">Vendredi</option>
			                                  </select>
                                      </div>
                                    </GridItem>
                                  </GridContainer>
                                  ...
                                  <GridContainer>
                                    <GridItem xs={12} sm={12} md={12}>
                                     ...
                                     <div style={{margin:'2% 0% 1% 0%',cursor:'pointer'}}>
                                         <span style={{float:'left',marginRight:'5%'}}>Activité</span>

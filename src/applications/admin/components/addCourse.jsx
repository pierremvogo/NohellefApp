...
const AddCourse = ({error, lessonData}) => {
                                     ...
                                     <div style={{margin:'2% 0% 1% 0%',cursor:'pointer'}}>
                                         <div>
                                            <div style={{
                                                margin:'2% 2% 0% 0%',
                                                color:'blue',
                                                fontSize:'1.2vw'}}><strong style={{marginRight:'2%'}}>Nouveau Cours</strong> 
                                  ...
                                  <GridContainer>
                                    <GridItem xs={12} sm={12} md={12}>
                                        <GridContainer>
                                            ...
                                            Nom du cours
                                                <div style={{margin:'0% 0% 5% 0%',width:'100%'}}>
                                                      <input type='text' value={lessonData.courseName}  style={{
                                        ...
                                        <GridContainer>
                                            ...
                                            Nombre d'UE
                                                <div style={{margin:'0% 0% 5% 0%',width:'100%'}}>
                                                      <input type='text' value={lessonData.nbLesson}   style={{
                                    ...
                                    <GridItem xs={12} sm={12} md={12}>
                                     ...
                                     <div style={{margin:'2% 0% 1% 0%',cursor:'pointer'}}>
                                         <select name="pets" id="pet-select">
                                            <option value="dog">{lessonData.speciality}</option>
